            ...
            <div className="col-sm-6">
              <div className="card shadow h-100">
                ...
                <div className="card-body pb-0">
                  ...
                  {/* Title */}
                  <h5 className="card-title fw-normal"><Link href="#">Sketch from A to Z: for app designer</Link></h5>
            ...
            <div className="col-sm-6">
              <div className="card shadow h-100">
                ...
                <div className="card-body pb-0">
                  ...
                  {/* Title */}
                  <h5 className="card-title fw-normal"><Link href="#">Create a Design System in Figma</Link></h5>
        ...
        <div className="tiny-slider-inner" data-autoplay="false" data-arrow="true" data-dots="false" data-items={4} data-items-lg={3} data-items-md={2} data-items-xs={1}>
          ...
          <div className="card bg-transparent">
            <div className="position-relative">
              ...
              <div className="card-img-overlay d-flex flex-column p-3">
                <div className="w-100 mt-auto text-end">
                  {/* Card category */}
                  <Link href="#" className="badge text-bg-info rounded-1"><i className="fas fa-user-graduate me-2" />25</Link>
                  <Link href="#" className="badge text-bg-orange rounded-1"><i className="fas fa-clipboard-list me-2" />15</Link>
                </div>
              </div>
            </div>
            {/* Card body */}
            <div className="card-body text-center">
              {/* Title */}
              <h5 className="card-title"><Link href="#">Jacqueline Miller</Link></h5>
          ...
          <div className="card bg-transparent">
            <div className="position-relative">
              ...
              <div className="card-img-overlay d-flex flex-column p-3">
                <div className="w-100 mt-auto text-end">
                  {/* Card category */}
                  <Link href="#" className="badge text-bg-info rounded-1"><i className="fas fa-user-graduate me-2" />118</Link>
                  <Link href="#" className="badge text-bg-orange rounded-1"><i className="fas fa-clipboard-list me-2" />09</Link>
                </div>
              </div>
            </div>
            {/* Card body */}
            <div className="card-body text-center">
              {/* Title */}
              <h5 className="card-title"><Link href="#">Samuel Bishop</Link></h5>
          ...
          <div className="card bg-transparent">
            <div className="position-relative">
              ...
              <div className="card-img-overlay d-flex flex-column p-3">
                <div className="w-100 mt-auto text-end">
                  {/* Card category */}
                  <Link href="#" className="badge text-bg-info rounded-1"><i className="fas fa-user-graduate me-2" />92</Link>
                  <Link href="#" className="badge text-bg-orange rounded-1"><i className="fas fa-clipboard-list me-2" />38</Link>
                </div>
              </div>
            </div>
            {/* Card body */}
            <div className="card-body text-center">
              {/* Title */}
              <h5 className="card-title"><Link href="#">Dennis Barrett</Link></h5>
          ...
          <div className="card bg-transparent">
            <div className="position-relative">
              ...
              <div className="card-img-overlay d-flex flex-column p-3">
                <div className="w-100 mt-auto text-end">
                  {/* Card category */}
                  <Link href="#" className="badge text-bg-info rounded-1"><i className="fas fa-user-graduate me-2" />82</Link>
                  <Link href="#" className="badge text-bg-orange rounded-1"><i className="fas fa-clipboard-list me-2" />05</Link>
                </div>
              </div>
            </div>
            {/* Card body */}
            <div className="card-body text-center">
              {/* Title */}
              <h5 className="card-title"><Link href="#">Carolyn Ortiz</Link></h5>
          ...
          <div className="card bg-transparent">
            <div className="position-relative">
              ...
              <div className="card-img-overlay d-flex flex-column p-3">
                <div className="w-100 mt-auto text-end">
                  {/* Card category */}
                  <Link href="#" className="badge text-bg-info rounded-1"><i className="fas fa-user-graduate me-2" />50</Link>
                  <Link href="#" className="badge text-bg-orange rounded-1"><i className="fas fa-clipboard-list me-2" />10</Link>
                </div>
              </div>
            </div>
            {/* Card body */}
            <div className="card-body text-center">
              {/* Title */}
              <h5 className="card-title"><Link href="#">Billy Vasquez</Link></h5>
