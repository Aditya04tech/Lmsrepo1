    ...
    <div className="page-content-wrapper border">
      ...
      <div className="row mb-3">
        <div className="col-12 d-sm-flex justify-content-between align-items-center">
          ...
          <Link href="instructor-create-course.html" className="btn btn-sm btn-primary mb-0">Create a Course</Link>
        </div>
      </div>
      {/* Card START */}
            ...
            <table className="table table-dark-gray align-middle p-4 mb-0 table-hover">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <div className="d-flex align-items-center position-relative">
                      ...
                      <h6 className="table-responsive-title mb-0 ms-2">	
                        <Link href="#" className="stretched-link">Building Scalable APIs with GraphQL</Link>
                      </h6>
                    </div>
                  </td>
                  {/* Table data */}
                  ...
                  {/* Table data */}
                  <td>
                    <Link href="#" className="btn btn-sm btn-success me-1 mb-1 mb-md-0">Edit</Link>
                ...
                <tr>
                  ...
                  <td>
                    <div className="d-flex align-items-center position-relative">
                      ...
                      {/* Title */}
                      <h6 className="table-responsive-title mb-0 ms-2">	
                        <Link href="#" className="stretched-link">Bootstrap 5 From Scratch</Link>
                      </h6>
                    </div>
                  </td>
                  {/* Table data */}
                ...
                <tr>
                  ...
                  <td>
                    <div className="d-flex align-items-center position-relative">
                      ...
                      {/* Title */}
                      <h6 className="table-responsive-title mb-0 ms-2">	
                        <Link href="#" className="stretched-link">Graphic Design Masterclass</Link>
                      </h6>
                    </div>
                  </td>
                  {/* Table data */}
                ...
                <tr>
                  ...
                  <td>
                    <div className="d-flex align-items-center position-relative">
                      ...
                      {/* Title */}
                      <h6 className="table-responsive-title mb-0 ms-2">	
                        <Link href="#" className="stretched-link">Learn Invision</Link>
                      </h6>
                    </div>
                  </td>
                  {/* Table data */}
                ...
                <tr>
                  ...
                  <td>
                    <div className="d-flex align-items-center position-relative">
                      ...
                      {/* Title */}
                      <h6 className="table-responsive-title mb-0 ms-2">	
                        <Link href="#" className="stretched-link">JavaScript: Full Understanding</Link>
                      </h6>
                    </div>
                  </td>
                  {/* Table data */}
                ...
                <tr>
                  ...
                  <td>
                    <div className="d-flex align-items-center position-relative">
                      ...
                      {/* Title */}
                      <h6 className="table-responsive-title mb-0 ms-2">	
                        <Link href="#" className="stretched-link">Build Responsive Websites with HTML</Link>
                      </h6>
                    </div>
                  </td>
                  {/* Table data */}
                ...
                <tr>
                  ...
                  <td>
                    <div className="d-flex align-items-center position-relative">
                      ...
                      {/* Title */}
                      <h6 className="table-responsive-title mb-0 ms-2">	
                        <Link href="#" className="stretched-link">Build Websites with CSS</Link>
                      </h6>
                    </div>
                  </td>
                  {/* Table data */}
