            ...
            <div className="col-sm-6 col-lg-4">
              <div className="text-center p-4 bg-light rounded-3">
                <h6 className="text-body">To be paid
                  <Link tabIndex={0} className="h6 mb-0" role="button" data-bs-toggle="popover" data-bs-trigger="focus" data-bs-placement="top" data-bs-content="After US royalty withholding tax">
