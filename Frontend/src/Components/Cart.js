...
const Cart = ({ cart, onAdd, onRemove, onClearCart,cartCount,handleLogout }) => {
...
<div
                  ...
                  >
                    <div>
                      ...
                      <p>Your cart is empty add some course </p>
                    ...
                    >
                      ...
                      <button onClick={() => navigate("/course")}  className="btn btn-lg btn-success ">
                        Add More Products
                      </button>
                    </div>
                  ) : (
