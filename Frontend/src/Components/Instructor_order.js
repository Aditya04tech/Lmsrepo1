                ...
                <table className="table table-dark-gray align-middle p-4 mb-0 table-hover">
                  ...
                  <tbody>
                    ...
                    <tr>
                      {/* Table data */}
                      <td>
                        <h6 className="table-responsive-title mt-2 mt-lg-0 mb-0"><Link href="#">The complete Digital Marketing Course - 8 Course in 1</Link></h6>
                      </td>
                      {/* Table data */}
                      <td className="text-center text-sm-start text-primary-hover">
                        <Link href="#" className="text-body"><u>#125489</u></Link>
                      </td>
                      {/* Table data */}
                      <td>18/1/2023</td>
                      {/* Table data */}
                    ...
                    <tr>
                      {/* Table data */}
                      <td>
                        <h6 className="table-responsive-title mt-2 mt-lg-0 mb-0"><Link href="#">Time Management Mastery: Do More, Stress Less</Link></h6>
                      </td>
                      {/* Table data */}
                      <td className="text-center text-sm-start text-primary-hover">
                        <Link href="#" className="text-body"><u>#235486</u></Link>
                      </td>
                      {/* Table data */}
                      <td>25/1/2023</td>
                      {/* Table data */}
                    ...
                    <tr>
                      {/* Table data */}
                      <td>
                        <h6 className="table-responsive-title mt-2 mt-lg-0 mb-0"><Link href="#">Building Scalable APIs with GraphQL</Link></h6>
                      </td>
                      {/* Table data */}
                      <td className="text-center text-sm-start text-primary-hover">
                        <Link href="#" className="text-body"><u>#0215789</u></Link>
                      </td>
                      {/* Table data */}
                      <td>4/9/2020</td>
                      {/* Table data */}
                    ...
                    <tr>
                      {/* Table data */}
                      <td>
                        <h6 className="table-responsive-title mt-2 mt-lg-0 mb-0"><Link href="#">Sketch from A to Z: for app designer</Link></h6>
                      </td>
                      {/* Table data */}
                      <td className="text-center text-sm-start text-primary-hover">
                        <Link href="#" className="text-body"><u>#0135689</u></Link>
                      </td>
                      {/* Table data */}
                      <td>5/1/2023</td>
                      {/* Table data */}
                    ...
                    <tr>
                      {/* Table data */}
                      <td>
                        <h6 className="table-responsive-title mt-2 mt-lg-0 mb-0"><Link href="#">Build Responsive Websites with HTML</Link></h6>
                      </td>
                      {/* Table data */}
                      <td className="text-center text-sm-start text-primary-hover">
                        <Link href="#" className="text-body"><u>#0587623</u></Link>
                      </td>
                      {/* Table data */}
                      <td>2/1/2023</td>
                      {/* Table data */}
                    ...
                    <tr>
                      {/* Table data */}
                      <td>
                        <h6 className="table-responsive-title mt-2 mt-lg-0 mb-0"><Link href="#">JavaScript: Full Understanding</Link></h6>
                      </td>
                      {/* Table data */}
                      <td className="text-center text-sm-start text-primary-hover">
                        <Link href="#" className="text-body"><u>#0215789</u></Link>
