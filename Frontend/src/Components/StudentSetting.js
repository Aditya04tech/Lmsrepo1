            ...
            <div className="row d-flex justify-content-between">
              ...
              <div className="col-auto mt-4 mt-md-0">
                <div className="avatar avatar-xxl mt-n3">
                  <img className="avatar-img rounded-circle border border-white border-3 shadow" src="assets/images/avatar/01.jpg" alt="student image" aria-hidden="true" />
                </div>
              </div>
              {/* Profile info */}
                ...
                <div className="card bg-transparent">
                  ...
                  <div className="card-body">
                    ...
                    <div className="d-sm-flex justify-content-end">
                      ...
                      <Link href="#" className="btn btn-sm btn-outline-secondary mb-0">Cancel</Link>
                    </div>
                  </div>
                  {/* Card body END */}
                </div>
