                ...
                <div className="row g-0">
                  ...
                  <div className="col-md-9">
                    <div className="card-body">
                      {/* Title */}
                      <h3 className="card-title"><Link href="#">The Complete Digital Marketing Course - 12 Courses in 1</Link></h3>
                      {/* Info */}
                      ...
                      {/* button */}
                      <Link href="#" className="btn btn-primary-soft btn-sm mb-0">Resume course</Link>
                    </div>
                  </div>
                </div>
              </div>
                        ...
                        <div>
                          <div className="d-flex justify-content-between align-items-center mb-2">
                            <div className="position-relative d-flex align-items-center">
                              <Link href="#" className="btn btn-success btn-round btn-sm mb-0 stretched-link position-static">
                          ...
                          <Link href="#" className="btn btn-xs btn-dark mb-0">Play again</Link>
                          {/* Notes START */}
                            ...
                            <div className="card card-body p-0 mt-2">
                              ...
                              <div className="d-flex justify-content-between bg-light rounded-2 p-2 mb-2">
                                ...
                                <div className="d-flex">
                                  <Link href="#" className="btn btn-sm btn-light btn-round me-2 mb-0"><i className="bi fa-fw bi-play-fill" /></Link>
                                  <Link href="#" className="btn btn-sm btn-light btn-round mb-0"><i className="bi fa-fw bi-trash-fill" /></Link>
                                </div>
                              </div>
                              {/* Note item */}
                              <div className="d-flex justify-content-between bg-light rounded-2 p-2 mb-2">
                  ...
                  <div id="collapse-2" className="accordion-collapse collapse" aria-labelledby="heading-2" data-bs-parent="#accordionExample2">
                    ...
                    <div className="accordion-body mt-3">
                      <div className="vstack gap-3">
                        ...
                        <div className="d-flex justify-content-between align-items-center">
                          <div className="position-relative d-flex align-items-center">
                            <Link href="#" className="btn btn-light btn-round btn-sm mb-0 stretched-link position-static" data-bs-toggle="modal" data-bs-target="#coursePremium">
              ...
              <div className="card">
                <div className="row g-0">
                  ...
                  <div className="col-md-9">
                    <div className="card-body">
                      {/* Title */}
                      <h3 className="card-title"><Link href="#">Sketch from A to Z: for app designer</Link></h3>
                      {/* Info */}
                      <ul className="list-inline mb-2">
