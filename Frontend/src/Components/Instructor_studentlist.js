                ...
                <table className="table table-dark-gray align-middle p-4 mb-0 table-hover">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        <div className="d-flex align-items-center position-relative">
                          ...
                          <div className="mb-0 ms-2">
                            {/* Title */}
                            <h6 className="mb-0"><Link href="#" className="stretched-link">Lori Stevens</Link></h6>
                            {/* Address */}
                      ...
                      {/* Table data */}
                      <td>
                        <Link href="#" className="btn btn-success-soft btn-round me-1 mb-0" data-bs-toggle="tooltip" data-bs-placement="top" title="Message"><i className="far fa-envelope" /></Link>
                    ...
                    <tr>
                      ...
                      <td>
                        <div className="d-flex align-items-center position-relative">
                          ...
                          <div className="mb-0 ms-2">
                            {/* Title */}
                            <h6 className="mb-0"><Link href="#" className="stretched-link">Dennis Barrett</Link></h6>
                            {/* Address */}
                    ...
                    <tr>
                      ...
                      <td>
                        <div className="d-flex align-items-center position-relative">
                          ...
                          <div className="mb-0 ms-2">
                            {/* Title */}
                            <h6 className="mb-0"><Link href="#" className="stretched-link">Billy Vasquez</Link></h6>
                            {/* Address */}
                    ...
                    <tr>
                      ...
                      <td>
                        <div className="d-flex align-items-center position-relative">
                          ...
                          <div className="mb-0 ms-2">
                            {/* Title */}
                            <h6 className="mb-0"><Link href="#" className="stretched-link">Carolyn Ortiz</Link></h6>
                            {/* Address */}
                    ...
                    <tr>
                      ...
                      <td>
                        <div className="d-flex align-items-center position-relative">
                          ...
                          <div className="mb-0 ms-2">
                            {/* Title */}
                            <h6 className="mb-0"><Link href="#" className="stretched-link">Larry Lawson</Link></h6>
                            {/* Address */}
                    ...
                    <tr>
                      ...
                      <td>
                        <div className="d-flex align-items-center position-relative">
                          ...
                          <div className="mb-0 ms-2">
                            {/* Title */}
                            <h6 className="mb-0"><Link href="#" className="stretched-link">Frances Guerrero</Link></h6>
                            {/* Address */}
