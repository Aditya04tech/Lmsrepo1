                      ...
                      <td>
                        <div className="d-flex align-items-center">
                          ...
                          <div className="mb-0 ms-2">
                            {/* Title */}
                            <h6 className="table-responsive-title"><Link href="#">Building Scalable APIs with GraphQL</Link></h6>
                            {/* Info */}
                    ...
                    <tr>
                      ...
                      <td>
                        <div className="d-flex align-items-center">
                          ...
                          <div className="mb-0 ms-2">
                            {/* Title */}
                            <h6 className="table-responsive-title"><Link href="#">Create a Design System in Figma</Link></h6>
                            {/* Info */}
                            <div className="overflow-hidden">
                    ...
                    <tr>
                      ...
                      <td>
                        <div className="d-flex align-items-center">
                          ...
                          <div className="mb-0 ms-2">
                            {/* Title */}
                            <h6 className="table-responsive-title"><Link href="#">The Complete Web Development in python</Link></h6>
                            {/* Info */}
                            <div className="overflow-hidden">
                    ...
                    <tr>
                      ...
                      <td>
                        <div className="d-flex align-items-center">
                          ...
                          <div className="mb-0 ms-2">
                            {/* Title */}
                            <h6 className="table-responsive-title"><Link href="#">Digital Marketing Masterclass</Link></h6>
                            {/* Info */}
                            <div className="overflow-hidden">
                    ...
                    <tr>
                      ...
                      <td>
                        <div className="d-flex align-items-center">
                          ...
                          <div className="mb-0 ms-2">
                            {/* Title */}
                            <h6 className="table-responsive-title"><Link href="#">Graphic Design Masterclass</Link></h6>
                            {/* Info */}
                            <div className="overflow-hidden">
